    ...
    <>
      ...
      <Box display={"flex"} justifyContent={"center"} sx={{ mt: 5 }}>
        <Box textAlign="left" sx={{ marginRight: 20, marginLeft: 20 }}>
          ...
          <HeaderText title="50% Coupon Usage" />
          <Typography>
            {" "}
            <li>
              <strong>Eligibility: </strong>
              This coupon is valid for use at LaundroMapp locations only.{" "}
            </li>
            <li>
            ...
            <li>
              ...
              The coupon cannot be applied to standard laundry services provided
              by LaundroMapp
            </li>
            <li>
              <strong> Redemption: </strong>
              Coupon must be presented at the time of payment. Digital or
              printed versions are acceptable.{" "}
            </li>
            <li>
              <strong>Limitations: </strong>
              One coupon per customer. Coupon cannot be combined with other
              promotions or discounts.
            </li>
            <li>
              <strong>Non-Transferable: </strong>The coupon is for personal use
              and cannot be sold or transferred.
            </li>
            <li>
              {" "}
              <strong>No Cash Value: </strong>Coupon has no cash value and
              cannot be redeemed for cash or store credit.{" "}
            </li>
            <li>
              <strong>Lost or Stolen Coupons: </strong>LaundroMapp is not
              responsible for lost or stolen coupons.{" "}
            </li>
            <li>
              <strong>Modification Rights: </strong>LaundroMapp reserves the
              right to modify or cancel the offer at any time without prior
              notice.
            </li>
            <li>
              {" "}
              <strong>Contact Information: </strong>For any questions or
              clarifications, please contact LaundroMapp at (111)222-3333 or
              fakeemail@laundromapp.com
            </li>
            <li>
              {" "}
              <strong>Compliance: </strong>Use of this coupon signifies
